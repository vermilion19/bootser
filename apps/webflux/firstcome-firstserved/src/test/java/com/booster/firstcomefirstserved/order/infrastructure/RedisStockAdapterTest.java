...
class RedisStockAdapterTest {
    ...
    void setup() {
        ...
        redisStockAdapter.setStock(ITEM_ID, 10).block();
    }
    ...
    void decreaseStock_success() {
        StepVerifier.create(redisStockAdapter.decreaseStock(ITEM_ID, 1))
                .expectNext(true)
                .verifyComplete();
    }
    ...
    void decreaseStock_fail_over_quantity() {
        StepVerifier.create(redisStockAdapter.decreaseStock(ITEM_ID, 11))
                .expectNext(false)
                .verifyComplete();
    }
    ...
    void decreaseStock_concurrency() {
        ...
        StepVerifier.create(redisStockAdapter.decreaseStock(ITEM_ID, 2))
                .expectNext(true)
                .verifyComplete();

        StepVerifier.create(redisStockAdapter.decreaseStock(ITEM_ID, 3))
                .expectNext(true)
                .verifyComplete();

...
public class CatalogDataInitController {

    private final CatalogDataInitializer dataInitializer;

    @PostMapping
    public ResponseEntity<String> start() {
        try {
            dataInitializer.initializeAsync();
            return ResponseEntity.accepted().body("catalog 테스트 데이터 적재를 시작했습니다.");

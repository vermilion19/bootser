...
public class RankingDataInitController {

    private final RankingDataInitializer dataInitializer;

    @PostMapping
    public ResponseEntity<String> start() {
        try {
            dataInitializer.initializeAsync();
            return ResponseEntity.accepted().body("ranking 테스트 데이터 적재를 시작했습니다.");
